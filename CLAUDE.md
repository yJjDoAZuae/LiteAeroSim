...
| [docs/architecture/system/future/](docs/architecture/system/future/) | Architecture | Target state registry: requirements, use cases, element registry, dataflow registry, diagrams, ICDs |
