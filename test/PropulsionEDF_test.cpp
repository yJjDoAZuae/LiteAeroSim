...
static nlohmann::json makeConfig() {
    return nlohmann::json{
        {"thrust_sl_n",       200.f},
        {"fan_diameter_m",    0.12f},
        {"inlet_area_m2",     0.011f},
        {"idle_fraction",     0.05f},
        {"rotor_tau_s",       0.1f},
        {"supply_voltage_v",  22.2f},
        {"fan_efficiency_nd", 0.75f},
        {"esc_efficiency_nd", 0.95f},
        {"dt_s",              0.01f},
    };
}
